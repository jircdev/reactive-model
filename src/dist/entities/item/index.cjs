...
class Registry extends model.ReactiveModel {
    get state() {
    ...
    constructor(entity, { properties, parent, register, ...data } = {}) {
        ...
        const { id } = data;
        __classPrivateFieldSet(this, _Registry_instanceId, (data === null || data === void 0 ? void 0 : data.instanceId) ? data.instanceId : uuid.v7(), "f");
 ...
 */
class RegistryFactory extends model.ReactiveModel {
 ...
 */
class Item extends model.ReactiveModel {
    get entity() {
    ...
    async load(args) {
        ...
        try {
            ...
            const pluginResult = await model.PluginManager.runHook('onBeforeLoad', this, loadArgs, __classPrivateFieldGet(this, _Item_entity, "f"));
            ...
            const afterPluginResult = await model.PluginManager.runHook('onAfterLoad', this, data, __classPrivateFieldGet(this, _Item_entity, "f"));
    ...
    async publish(data, options = {}) {
        ...
        try {
            ...
            const pluginResult = await model.PluginManager.runHook('onBeforePublish', this, publishData, __classPrivateFieldGet(this, _Item_entity, "f"));
            ...
            await model.PluginManager.runVoidHook('onAfterPublish', this, [result], __classPrivateFieldGet(this, _Item_entity, "f"));
    ...
    async delete(options) {
        ...
        try {
            ...
            const pluginResult = await model.PluginManager.runHook('onBeforeDelete', this, id, __classPrivateFieldGet(this, _Item_entity, "f"));
            ...
            await model.PluginManager.runVoidHook('onAfterDelete', this, [id], __classPrivateFieldGet(this, _Item_entity, "f"));
