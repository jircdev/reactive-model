...
class Collection extends ReactiveModel {
    ...
    async load(args = {}) {
        ...
        try {
            ...
            const pluginResult = await PluginManager.runHook('onBeforeList', this, loadArgs, __classPrivateFieldGet(this, _Collection_entity, "f"));
            ...
            const afterPluginResult = await PluginManager.runHook('onAfterList', this, entries, __classPrivateFieldGet(this, _Collection_entity, "f"));
