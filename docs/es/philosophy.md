...
Los agentes de IA a menudo adivinan cómo actualizar el estado o dónde encontrar una lógica específica. Con `@beyond-js/reactive`, la lógica está encapsulada en el modelo. La IA no necesita "inventar" una forma de guardar un usuario; simplemente llama a `user.publish()`.
