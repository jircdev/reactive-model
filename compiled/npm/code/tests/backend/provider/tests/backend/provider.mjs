...
import * as dependency_2 from '@beyond-js/reactive/tests/backend/database';
import * as dependency_3 from 'socket.io';
...
//# sourceMappingURL=tests/backend/provider.mjs.map