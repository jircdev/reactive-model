define(["exports", "module", "@beyond-js/kernel/bundle", "@beyond-js/events/events"], function (_exports, _amd_module, dependency_0, dependency_1) {
  "use strict";

  Object.defineProperty(_exports, "__esModule", {
    value: true
  });
  _exports.reactiveProps = _exports.reactiveProp = _exports.hmr = _exports.__beyond_pkg = _exports.ReactiveModel = void 0;
  const {
    Bundle: __Bundle
  } = dependency_0;
  const __pkg = new __Bundle({
    "module": {
      "vspecifier": "@beyond-js/reactive@0.0.3.beta.dts.1/model"
    },
    "type": "ts"
  ...
  **************************/
  ...
  // Module exports
  _exports.reactiveProps = reactiveProps;
  _exports.reactiveProp = reactiveProp;
  ...
  __pkg.exports.process = function ({
    ...
    (require || prop === 'ReactiveModel') && (_exports.ReactiveModel = ReactiveModel = require ? require('./index').ReactiveModel : value);
    (require || prop === 'reactiveProp') && (_exports.reactiveProp = reactiveProp = require ? require('./property').reactiveProp : value);
    (require || prop === 'reactiveProps') && (_exports.reactiveProps = reactiveProps = require ? require('./property').reactiveProps : value);
  };
...
//# sourceMappingURL=model.amd.js.map