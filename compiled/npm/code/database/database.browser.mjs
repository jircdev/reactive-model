...
import * as dependency_1 from 'dexie';
import * as dependency_2 from '@beyond-js/events/events';
import * as dependency_3 from '@beyond-js/kernel/core';

const {Bundle: __Bundle} = dependency_0;
const __pkg = new __Bundle({"module":{"vspecifier":"@beyond-js/reactive@0.0.3.beta.dts.1/database"},"type":"ts"}, import.meta.url).package();;
...
ims.set('./database', {hash: 2654661490, creator: function (require, exports) {
"use strict";
...
ims.set('./index', {hash: 1175347211, creator: function (require, exports) {
"use strict";
...
/*bundle */class DatabaseManager extends _events.Events {
  #promise;
  #ready;
  get ready() {
    return this.#ready;
...
/* bundle */const DBManager = new DatabaseManager();
exports.DBManager = DBManager;
}});

__pkg.exports.descriptor = [{"im":"./index","from":"DatabaseManager","name":"DatabaseManager"},{"im":"./index","from":"DBManager","name":"DBManager"}];

export let DatabaseManager, DBManager;

// Module exports
__pkg.exports.process = function({require, prop, value}) {
    (require || prop === 'DatabaseManager') && (DatabaseManager = require ? require('./index').DatabaseManager : value);
    (require || prop === 'DBManager') && (DBManager = require ? require('./index').DBManager : value);
...
//# sourceMappingURL=database.browser.mjs.map