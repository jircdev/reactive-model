...
const __pkg = new __Bundle({"module":{"vspecifier":"@beyond-js/reactive@0.0.3.beta.dts.1/layout/main"},"type":"widget"}, import.meta.url).package();;
...
brequire('@beyond-js/widgets/render').widgets.register([{"name":"main-layout","vspecifier":"@beyond-js/reactive@0.0.3.beta.dts.1/layout/main","is":"layout"}]);
