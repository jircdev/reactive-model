define(["exports", "module", "@beyond-js/kernel/bundle", "@beyond-js/reactive/model", "@beyond-js/reactive/database", "dexie", "@beyond-js/kernel/core"], function (_exports, _amd_module, dependency_0, dependency_1, dependency_2, dependency_3, dependency_4) {
  "use strict";

  Object.defineProperty(_exports, "__esModule", {
    value: true
  });
  _exports.hmr = _exports.__beyond_pkg = _exports.LocalProvider = _exports.Item = _exports.IProvider = _exports.CollectionLocalProvider = _exports.Collection = void 0;
  const {
    Bundle: __Bundle
  } = dependency_0;
  const __pkg = new __Bundle({
    "module": {
      "vspecifier": "@beyond-js/reactive@0.0.3.beta.dts.1/entities"
    },
    "type": "ts"
  ...
  ***************************/
  ...
  let Collection, CollectionLocalProvider, IProvider, Item, LocalProvider;

  // Module exports
  _exports.LocalProvider = LocalProvider;
  _exports.Item = Item;
  _exports.IProvider = IProvider;
  _exports.CollectionLocalProvider = CollectionLocalProvider;
  ...
  __pkg.exports.process = function ({
    ...
    (require || prop === 'Collection') && (_exports.Collection = Collection = require ? require('./collection/index').Collection : value);
    (require || prop === 'CollectionLocalProvider') && (_exports.CollectionLocalProvider = CollectionLocalProvider = require ? require('./collection/local-provider').CollectionLocalProvider : value);
    (require || prop === 'IProvider') && (_exports.IProvider = IProvider = require ? require('./interfaces/provider').IProvider : value);
    (require || prop === 'Item') && (_exports.Item = Item = require ? require('./item/index').Item : value);
    (require || prop === 'LocalProvider') && (_exports.LocalProvider = LocalProvider = require ? require('./item/local-provider').LocalProvider : value);
  };
...
//# sourceMappingURL=entities.amd.js.map