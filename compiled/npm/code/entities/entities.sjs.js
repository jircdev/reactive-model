System.register(["@beyond-js/kernel/bundle", "@beyond-js/reactive/model", "@beyond-js/reactive/database", "dexie", "@beyond-js/kernel/core"], function (_export, _context) {
  "use strict";

  var dependency_0, dependency_1, dependency_2, dependency_3, dependency_4, __Bundle, __pkg, ims, Collection, CollectionLocalProvider, IProvider, Item, LocalProvider, __beyond_pkg, hmr;
  _export({
    Collection: void 0,
  ...
  return {
    ...
    }, function (_beyondJsReactiveDatabase) {
      dependency_2 = _beyondJsReactiveDatabase;
    }, function (_dexie) {
      dependency_3 = _dexie;
    }, function (_beyondJsKernelCore) {
      dependency_4 = _beyondJsKernelCore;
    }],
    execute: function () {
      ({
        Bundle: __Bundle
...
//# sourceMappingURL=entities.sjs.js.map